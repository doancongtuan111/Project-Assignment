    ...
    public partial class frm_QLSanPham : Form
    {
        ...
        private void btnSuaSP_Click(object sender, EventArgs e)
        {
            if (lsvSP.SelectedItems.Count == 1)
            {
                ...
                string command = "update tbl_SanPham set TENSANPHAM = N'" + tensp + "', LOAISANPHAM = '" + loaisp + "',DONGIA = '" + dongia + "', MOTA = N'" + mota + "' where MASANPHAM = '" + txtMaSP.Text + "'";
                string tinhtrang = "";
                tinhtrang = webservice.excutedata(command);
                if (tinhtrang == "OK")
                {
        ...
        private void btnThemLoai_Click(object sender, EventArgs e)
        {
            ...
            string mota = txtMoTaLoai.Text;
                string them = "insert into tbl_LoaiSanPham (TENLOAI, MOTALOAI) values (N'" + tenloai + "','" + mota + "')";
                string tinhtrang = "";
                tinhtrang = webservice.excutedata(them);
                if (tinhtrang == "OK")
                {
